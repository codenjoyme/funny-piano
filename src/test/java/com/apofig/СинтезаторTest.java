...
public class СинтезаторTest {
    ...
    public void shouldPlayДоМажорСПервойОктавы() {
        синтезатор.звучать(ПерваяОктава.get(), Тональность.ДоМажор, 1, 120);
    ...
    public void shouldPlayЛяМажорСПервойОктавы() {
        синтезатор.звучать(ПерваяОктава.get(), Тональность.ЛяМажор, 1, 120);
    ...
    public void shouldPlayЛяМинорСПервойОктавы() {
        синтезатор.звучать(ПерваяОктава.get(), Тональность.ЛяМинор, 1, 120);
