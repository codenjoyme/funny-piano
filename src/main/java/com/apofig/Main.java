...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Звук l71 = Доля.половина(F4, A4, C5);
        Звук l72 = Доля.четверть(E4, G4, C5);
        Звук l73 = Доля.четверть(D4, F4, C5);
        Звук l74 = Доля.целая(C4, E4, C5);
        Шаблон s7p = Шаблон.подряд(l1).потом(l1).потом(l2).потом(l2);
        Шаблон s7 = s7p.потом(l31).потом(l31).потом(l71).потом(l71).потом(s7p).потом(l71).потом(l72).потом(l73).потом(l74);

        синтезатор.звучать(ss1.потом(ss2).потом(s7));
    }
