...
public class LetItBe {
    ...
    public static void main(String[] args) {
        ...
        Шаблон s71 = Шаблон.подряд(g4).потом(g8).потом(a4).потом(e4).потом(g4.увеличить(1.5)).потом(g4).потом(c8).потом(d8.увеличить(3));
        Шаблон s72 = Шаблон.подряд(ee8).потом(ee8).потом(ee8.увеличить(3)).потом(d4).потом(d8.увеличить(3)).потом(c8).потом(c8.увеличить(5));
        Шаблон s73 = Шаблон.подряд(ee8).потом(ee4).потом(ff4.увеличить(1.5)).потом(ee8).потом(ee4).потом(d4.увеличить(2)).потом(ee8).потом(d4).потом(c8.увеличить(4));
