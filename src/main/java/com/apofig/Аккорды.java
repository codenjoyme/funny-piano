...
public class Аккорды {
    ...
    static {
        ...
        аккорды.put("A", Трезвучие.Мажорное.get(ПерваяОктава.A4));
        аккорды.put("E", Трезвучие.Мажорное.get(ПерваяОктава.E4));
        аккорды.put("H", Трезвучие.Мажорное.get(ПерваяОктава.H4));
        аккорды.put("B", Трезвучие.Мажорное.get(ПерваяОктава.B4));
    }
